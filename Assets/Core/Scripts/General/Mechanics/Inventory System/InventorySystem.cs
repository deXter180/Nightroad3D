...
public class InventorySystem : Singleton<InventorySystem>
{
    ...
    private void Test()
    {
        ...
        PickedObject.SpawnSpellWorld(SpellTypes.ChainLightening, GameController.GetSpellInventorySO(SpellTypes.ChainLightening), PlayerController.Instance.transform.position + PlayerController.Instance.GetRandomPosWithoutY(throwDistance, -throwDistance));
